...
public interface QuestionsApi {
    ...
    @ApiOperation(value = "Get 10 random question from section", notes = "", response = QuestionDto.class, tags={ "MustKnowQuestion", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Successfully deleted question with Id", response = QuestionDto.class),
        @ApiResponse(code = 405, message = "Invalid input", response = QuestionDto.class) })
    @RequestMapping(value = "/Questions/{section}/{id}",
        method = RequestMethod.DELETE)
    default ResponseEntity<QuestionDto> deleteQuestionWithId(@ApiParam(value = "Section of CA",required=true ) @PathVariable("section") String section,
    ...
    default ResponseEntity<QuestionDto> updateQuestion(@ApiParam(value = "Section of CA" ,required=true ) @RequestBody QuestionDto questionDto) {
        // do some magic!
        return new ResponseEntity<QuestionDto>(HttpStatus.OK);
    }
    ...
    default ResponseEntity<QuestionDto> uploadQuestion(@ApiParam(value = "Section of CA" ,required=true ) @RequestBody QuestionDto questionDto) {
        // do some magic!
        return new ResponseEntity<QuestionDto>(HttpStatus.OK);
    }
